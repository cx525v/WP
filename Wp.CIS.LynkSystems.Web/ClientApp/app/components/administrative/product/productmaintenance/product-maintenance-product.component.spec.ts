...
describe('Product Maintenanc component', () => {
    ...
    let fixture: ComponentFixture<ProductMaintenanceProductComponent>,
        component: ProductMaintenanceProductComponent,
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ProductMaintenanceProductComponent);
    ...
    it('Should display the product type', async(() => {
        ...
        let event: Event = new Event("custom");
        let theProduct: ProductModel = new ProductModel();
        theProduct.productCode = 2;
        component._selectedProduct = theProduct;
        component.onRowSelect(event)

        fixture.detectChanges();

        expect(component._selectedProduct.productCode).toEqual(component._selectedProductForEdit.productCode);
    }));
