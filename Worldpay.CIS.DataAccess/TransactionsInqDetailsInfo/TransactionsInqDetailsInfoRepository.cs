...
{
    public class TransactionsInqDetailsInfoRepository: ITransactionsInqDetailsInfoRepository
    {
        private readonly IDatabaseConnectionFactory _connectionFactory;
        public TransactionsInqDetailsInfoRepository(IOptions<DataContext> optionsAccessor, IDatabaseConnectionFactory connectionFactory)
        {
