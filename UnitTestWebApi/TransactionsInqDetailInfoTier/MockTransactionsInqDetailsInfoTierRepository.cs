...
{
    public class MockTransactionsInqDetailsInfoTierRepository : ITransactionsInqDetailsInfoTierRepository
    {
        List<Wp.CIS.LynkSystems.Model.TransactionsInquiry> transinq;

        public bool FailGet { get; set; }

        public MockTransactionsInqDetailsInfoTierRepository()
        {
        ...
        public Task<GenericPaginationResponse<Wp.CIS.LynkSystems.Model.TransactionsInquiry>> GetTransactionInquiryCardNoResults(int terminalnbr, string CardNo, int CustomerId, string startDate, string endDate, int? SearchId, int CardType, int SkipRecords, int PageSize)
        {
            throw new NotImplementedException();
        }
